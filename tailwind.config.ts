...
export default {
  darkMode: ["class"],
  content: ["./index.html", "./src/**/*.{vue,ts,tsx}", "./pages/**/*.{vue,ts,tsx}", "./components/**/*.{vue,ts,tsx}", "./app/**/*.{vue,ts,tsx}"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      colors: {
        ...
        kanban: {
          ...
          "doing-accent": "hsl(var(--kanban-doing-accent))",
          testing: "hsl(var(--kanban-testing))",
          "testing-accent": "hsl(var(--kanban-testing-accent))",
